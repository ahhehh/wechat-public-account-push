...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6dd3f5f6d0066abb',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a6e6d4f9cb4b70f9b664441b8b0ea6c2',
  ...
  USERS: [
    {
      ...
      id: 'oa8Ss51NzuCUBt0zlhTiLUei2xo0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'u3mjp_K5TMubNvTeZM_AdDwArg9A-TmYEN86Lj4o8zI',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
